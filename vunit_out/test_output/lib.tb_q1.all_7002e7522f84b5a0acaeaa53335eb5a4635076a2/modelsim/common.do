...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/borg/Desktop/elementos/20b-ele-av1/vunit_out/modelsim/modelsim.ini -wlf {/home/borg/Desktop/elementos/20b-ele-av1/vunit_out/test_output/lib.tb_q1.all_7002e7522f84b5a0acaeaa53335eb5a4635076a2/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_q1/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /home/borg/Desktop/elementos/20b-ele-av1/vunit_out/test_output/lib.tb_q1.all_7002e7522f84b5a0acaeaa53335eb5a4635076a2/,tb path : /home/borg/Desktop/elementos/20b-ele-av1/testes/,use_color : true"} lib.tb_q1(tb)   -L vunit_lib -L lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/borg/Desktop/elementos/20b-ele-av1/vunit_out/modelsim/modelsim.ini -wlf {/home/borg/Desktop/elementos/20b-ele-av1/vunit_out/test_output/lib.tb_q1.all_7002e7522f84b5a0acaeaa53335eb5a4635076a2/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_q1/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /home/borg/Desktop/elementos/20b-ele-av1/vunit_out/test_output/lib.tb_q1.all_7002e7522f84b5a0acaeaa53335eb5a4635076a2/,tb path : /home/borg/Desktop/elementos/20b-ele-av1/testes/,use_color : true"} lib.tb_q1(tb)   -L vunit_lib -L lib' failed
...
proc is_test_suite_done {} {
    set fd [open "/home/borg/Desktop/elementos/20b-ele-av1/vunit_out/test_output/lib.tb_q1.all_7002e7522f84b5a0acaeaa53335eb5a4635076a2/vunit_results" "r"]
...
proc vunit_compile {} {
    ...
    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', './testeAV1.py', '--compile'], cwd='/home/borg/Desktop/elementos/20b-ele-av1', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
